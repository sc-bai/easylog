...
static const base::type::char_t* kUDPLevelLogValue    =   ELPP_LITERAL("UDP");
...
static const base::type::char_t* kUDPLevelShortLogValue      =   ELPP_LITERAL("U");
...
void LogFormat::updateFormatSpec(void) {
  ...
  }else if (m_level == Level::UDP) {
	  base::utils::Str::replaceFirstWithEscape(m_format, base::consts::kSeverityLevelFormatSpecifier,
		  base::consts::kUDPLevelLogValue);
	  base::utils::Str::replaceFirstWithEscape(m_format, base::consts::kSeverityLevelShortFormatSpecifier,
		  base::consts::kUDPLevelShortLogValue);
  }
